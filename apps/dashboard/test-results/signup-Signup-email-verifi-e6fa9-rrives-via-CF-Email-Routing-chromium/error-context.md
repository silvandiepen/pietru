...
- Name: signup.spec.ts >> Signup + email verification (full flow) >> 1. Verification email arrives via CF Email Routing
- Location: e2e/signup.spec.ts:88:3

# Error details

```
Error: Timed out waiting for received email: "Verify your email"
```
